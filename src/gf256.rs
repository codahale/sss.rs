...
pub fn mul(e: u8, a: u8) -> u8 {
    if e == 0 || a == 0 {
        ...
        EXP[(LOG[e as usize] as usize + LOG[a as usize] as usize) % 255]
    }
}
...
static EXP: [u8; 256] = [0x01, 0x03, 0x05, 0x0f, 0x11, 0x33, 0x55, 0xff, 0x1a, 0x2e, 0x72, 0x96,
...
static LOG: [u8; 256] = [0x00, 0x00, 0x19, 0x01, 0x32, 0x02, 0x1a, 0xc6, 0x4b, 0xc7, 0x1b, 0x68,
